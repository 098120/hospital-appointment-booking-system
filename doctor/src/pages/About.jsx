...
/>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          <p>
            ...
            dedicated to providing high-quality medical services with a focus on
            patient care and well-being.
          </p>

          <p>
            Prescripto is a leading healthcare platform that connects patients
            with top-rated doctors and medical professionals.
          </p>

          <b className='text-gray-800'>Our Vision</b>

          <p>
            Our vision is to revolutionize healthcare delivery by making it more
