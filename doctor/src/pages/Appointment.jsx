        ...
        <div className='flex items-center gap-3 w-full overflow-x-scroll mt-4'>
          {docSlots.length > 0 && docSlots[slotIndex].map((slot, index) => (
            <p
              ...
              className={`text-sm font-light flex-shrink-0 px-5 py-2 rounded-full cursor-pointer border ${slot.time === slotTime ? 'bg-primary text-white' : 'text-gray-400 border-gray-300'}`}
            >
              {slot.time}
            </p>
          ))}
